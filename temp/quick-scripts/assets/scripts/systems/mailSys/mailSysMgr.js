(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/systems/mailSys/mailSysMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '465278Wd2tOJrFKJYgx+b6s', 'mailSysMgr', __filename);
...
cc.Class({
        ...
        selectedTagNode: {
            ...
            set: function set(value) {
                ...
                if (this.selectedTagEffect.parent == null) {
                    ...
                    cc.tween(this.selectedTagEffect).to(0.1, { y: targetY }).start();
                }
            }
        },
        selectedTagEffect: {
    ...
    setOneMailReaded: function setOneMailReaded(mailId, indexOfOptions) {
        ...
        var relatedMailSectionNode = arguments[3];
...
cc._RF.pop();
        ...
        //# sourceMappingURL=mailSysMgr.js.map
