"use strict";
cc._RF.push(module, '087aeqBFGdNVKf4lAdrIbR/', 'mainSceneMgr');
...
cc.Class({
    ...
    setupUI: function setupUI() {
        ...
        if (flag == 1) {
            ...
            cc.tween(this.welfarySysButtonNode).repeatForever(cc.tween().to(0.3, { angle: -45 }).to(0.3, { angle: 0 }).to(0.3, { angle: 45 }).to(0.3, { angle: 0 }).delay(1)).start();
