...
for (var h = "function" == typeof __require && __require, s = 0; s < n.length; s++) a(n[s]);
return a;
}({
...
var s = e("sectionConfig")[n].levels[h];
if (s == t) return 1;
if (s == a) return 0;
}
}
...
for (var a in i) {
var h = i[a], s = this.helper.getLinesOfOneNode(h);
for (var o in s) {
var l = s[o];
...
var i = this.helper.makeRay(this.node.position, 3e3, t), n = this.helper.makeRay(this.node.position, 3e3, cc.v2(-t.x, -t.y)), a = this.helper.getLinesOfOneNode(e), h = this, s = function(e) {
var t = null;
for (var i in a) {
var n = a[i], s = h.helper.rayTest(e, n);
if (0 != s) return s;
}
null == t && (t = 5);
return t;
...
var s = a[h];
if (null != s.opendNode) {
null != (g = s.opendNode.getComponent(s.mgrName)) && "function" == typeof g.dataMonitored && g.dataMonitored(i, n);
}
}
var o = cc.director.getScene(), l = null;
switch (o.name) {
case "mainScene":
l = "mainSceneMgr";
break;
...
if (null != l) {
var g;
null != (g = o.getChildByName("Canvas").getComponent(l)) && "function" == typeof g.dataMonitored && g.dataMonitored(i, n);
}
return !0;
}
};
...
var s = Object.keys(t)[h];
(function(e, t) {
cc.director.preloadScene(e, null, function(h, s) {
cc.log("preload scene: " + e);
var o = s.scene.children[0], l = {}, g = function(e) {
var t = {};
t.x = e.x;
t.y = e.y;
t.width = e.width;
...
i *= this.dragSpeed;
n *= this.dragSpeed;
var a = this.camaraNode.getComponent(cc.Camera), h = cc.find("Canvas"), s = this.camaraNode.x + i, o = this.camaraNode.y + n, l = s + h.width / 2 * (1 / a.zoomRatio), g = s - h.width / 2 * (1 / a.zoomRatio), r = o + h.height / 2 * (1 / a.zoomRatio), d = o - h.height / 2 * (1 / a.zoomRatio);
l <= this.maxBoundX && g >= this.minBoundX && (this.camaraNode.x = s);
...
if (0 == a) return !1;
var h = ((t.x - e.x) * (n.x - i.x) * (i.y - e.y) + (t.y - e.y) * (n.x - i.x) * e.x - (n.y - i.y) * (t.x - e.x) * i.x) / a, s = -((t.y - e.y) * (n.y - i.y) * (i.x - e.x) + (t.x - e.x) * (n.y - i.y) * e.y - (n.x - i.x) * (t.y - e.y) * i.y) / a;
return this.similarMinus(h, e.x) * this.similarMinus(h, t.x) <= 0 && this.similarMinus(s, e.y) * this.similarMinus(s, t.y) <= 0 && this.similarMinus(h, i.x) * this.similarMinus(h, n.x) <= 0 && this.similarMinus(s, i.y) * this.similarMinus(s, n.y) <= 0 && {
x: h,
y: s
};
},
...
if (i >= t) return e;
n.normalizeSelf();
var a = t * n.x, h = t * n.y, s = (t - i) / t, o = e.x + s * a, l = e.y + s * h;
return cc.v2(o, l);
},
...
var a = i.x * t, h = i.y * t, s = e.x + a, o = e.y + h;
n.p2 = cc.v2(s, o);
return n;
},
getLinesOfOneNode: function(e) {
var t = e.height / 2, i = cc.v2(e.x - e.width / 2, e.y - t), n = cc.v2(e.x + e.width / 2, e.y - t), a = cc.v2(i.x, i.y + e.height), h = cc.v2(n.x, n.y + e.height), s = cc.v2(e.x - e.width / 2, e.y + e.height / 2), o = cc.v2(s.x, s.y - e.height), l = cc.v2(e.x + e.width / 2, e.y + e.height / 2), g = cc.v2(l.x, l.y - e.height), r = {
p1: i,
p2: n
}, d = {
p1: a,
...
c = this.rotateSegment(s, o, cc.v2(e.x, e.y), -e.angle);
...
var h = t.x, s = a.x, o = n.y, l = i.y, g = [ t, n, i, a ];
for (var r in g) {
var d = g[r];
h > d.x && (h = d.x);
s < d.x && (s = d.x);
...
for (var s in a) {
var o = a[s], l = this.makeRay(o, n, i);
h.push(l);
}
...
for (var s = 100; 0 == this.resolveShadows(i, e) && !(s <= 0); ) s -= 1;
var o = !1;
for (var t in i) {
...
var s = e("sectionConfig")[a].levels;
n = s[0];
}
h = null == a ? {
currentLevel: n
...
var o = "minStep_level_" + this.level.toString(), l = e("dataMgr").playerData.minSteps[o];
...
var h = e[a];
if (n != h) {
var s = this._selectStaticShadowAndShaodwForResolved(n, h, t);
if (0 != s) {
var o = s.staticShadow, l = s.shadowForResolved, g = this.helper.getLinesOfOneNode(o), r = null, d = this.helper.makeRay(cc.v2(o.x, o.y), 1e3, cc.v2(-t.x, -t.y));
for (var c in g) {
var y = g[c];
...
var a = e.dis, h = !1, s = !1, o = n.helper.getLinesOfOneNode(t);
for (var l in o) {
var g = o[l];
...
var a = t.wallPathes[n], h = a.points, s = [];
for (var o in h) {
var l = null;
if (0 == o) l = cc.v2(h[o].x, h[o].y); else {
var g = h[o];
l = cc.v2(s[o - 1].x + g.x, s[o - 1].y + g.y);
}
s.push(l);
}
...
for (var o in s) if (0 != o) {
var u = cc.instantiate(this.linePrefab);
u.height = r;
var p = cc.v2(s[o].x - s[o - 1].x, s[o].y - s[o - 1].y);
u.width = p.mag();
...
for (var a in i) {
var h = i[a], s = cc.instantiate(t);
this._setupNodePropertyByConfig(s, h);
n.addChild(s);
}
},
...
for (var a in i) {
var h = i[a], s = new cc.Node(h.name);
for (var a in h.children) {
var o = h.children[a], l = cc.instantiate(t);
...
for (var a in i) {
var h = i[a], s = cc.instantiate(t), o = h.basic, l = h.mgr, g = s.getComponent("bulletMgr");
g.bulletType = l.bulletType;
2 == l.bulletType && (s.getComponent(cc.Sprite).spriteFrame = g.sliderFrame);
...
for (var s in h) {
var o = h[s], l = o.conditionType, g = o.conditionPara;
if (1 == l) {
if (g == this.level) {
i = !0;
var r = e("dataMgr").playerData.mailConditionIndex[a];
2 == this.level && cc.log(s, r);
(s < r || -1 == r) && (n = !0);
return [ i, n ];
}
} else if (2 == l) {
g.levelId == this.level && (i = !0);
(s < (r = e("dataMgr").playerData.mailConditionIndex[a]) || -1 == r) && (n = !0);
return [ i, n ];
}
}
}
...
var s = cc.sys.localStorage.getItem("deviceId");
if (null == s) {
...
var s = this;
y.on("click", function() {
s.relatedMailSysMgr.setOneMailReaded(s.mailId, -1, function() {
s.close();
}, s.relatedMailSectionNode);
});
...
(function(t, i, a, h) {
t.on("click", function() {
s.relatedMailSysMgr.setOneMailReaded(s.mailId, h, function() {
if (1 == i) s.close(); else if (2 == i) {
e("systemsMgr").mailSysGloableSendOneMail(a.mailId, n.tag, function() {}, a.delay);
s.close();
}
}, s.relatedMailSectionNode);
});
})(g, l.operationType, l.operationPara, o);
i.addChild(g);
}
...
(function(t, i) {
t.on("click", function() {
s.selectedTag != i && (s.selectedTag = i);
s.selectedTagNode != t && (s.selectedTagNode = t);
});
t.getComponent("redPointMgr").redPointShowCondition = function() {
...
var h = e("mailConfig"), s = 0;
for (var o in n) {
var l = n[o], g = e("dataMgr").playerData.mails[l], r = cc.instantiate(this.mailSectionPrefab), d = r.getChildByName("icon_unread"), c = r.getChildByName("icon_readed"), y = r.getChildByName("titleLabel"), u = r.getChildByName("seperateLine");
if (1 == g.status) {
d.active = !1;
c.active = !0;
...
r.name = l.toString();
s = s + y.height + 2;
o != n.length - 1 && (s += this.mailSectionNodeDis);
a = this;
(function(e, t) {
e.on("click", function() {
a.openOneMail(t, e);
...
s > this.mailSectionContentNode.height && (this.mailSectionContentNode.height = s);
} else {
...
var s = l[0], o = l[1];
i = t.getFormatedString(131, [ s.toString(), o.toString() ]);
this.notiSection.getChildByName("notiLabel").getComponent(cc.Label).string = i;
}
...
s = l[0], h = l[1], i = t.getFormatedString(132, [ s.toString(), h.toString(), r.toString() ]);
this.notiSection.getChildByName("notiLabel").getComponent(cc.Label).string = i;
}
}
...
if (1 != h.status) {
var s = e("networkMgr"), o = s.makeMessageObj("mailModule", "readMailMessageType");
...
var a = i.levels;
for (var h in a) {
var s = a[h], o = cc.instantiate(this.levelNodePrefab), l = o.getComponent("levelNodeMgr");
l.level = s;
l.levelNumLabelNode.getComponent(cc.Label).string = (parseInt(h) + 1).toString();
l.status = this._checkLevelStatus(s);
l.delegate = this;
...
var h = n.levels.length, s = 2 * Math.PI / h, o = cc.v2(this.rotaedCopiedRadius, 0).rotate(-i * s);
t.x = o.x;
t.y = o.y;
} else {
t.x = a[i].x;
...
var s = "http://" + i + ":" + t.toString() + "/" + n.toString();
h.open("POST", s);
h.send(e);
},
...
if (null != a) {
var h = n.basicIp, s = n.basicPort;
null != a.ip && (h = a.ip);
null != a.port && (s = a.port);
return {
ip: h,
port: s,
suffix: a.suffix,
...
var h = cc.instantiate(a), s = h.getChildByName("bg");
s.width = cc.winSize.width;
s.height = cc.winSize.height;
...
var s = h.mailId, o = h.timeStamp, l = {
status: 0,
tag: h.tag,
timeStamp: o,
selectedOptionIndex: -1
};
e("dataMgr").playerData.mails[s] = l;
}
}
}
};
...
var a = this.contentSectionNode.getChildByName("seperateLineUp"), h = this.contentSectionNode.getChildByName("seperateLineDown"), s = n.height + 2 * this.contentSpace + a.height + h.height;
this.contentSectionNode.height = s;
a.y = 0;
n.y = a.y - a.height - this.contentSpace;
h.y = -s + h.height;
var o = e("textConfig"), l = (t = this._getMailSectionInfo(), 0);
for (var g in t) {
...
for (var a in t) {
var h = t[a], s = h.conditions, o = e("dataMgr").playerData.mailConditionIndex[a];
for (var l in s) {
var g = s[l], r = g.conditionType, d = g.conditionPara, c = null;
...
var s = null;
"heart" == this.costResult.type ? s = {
heart: e("dataMgr").playerData.heart - this.costResult.num
} : "physicalPower" == this.costResult.type && (s = {
physicalPower: e("dataMgr").playerData.physicalPower - this.costResult.num
});
h.message.commitBody = s;
var o = this;
h.successCallBack = function() {
"heart" == o.costResult.type ? e("dataMgr").playerData.heart = s.heart : "physicalPower" == o.costResult.type && (e("dataMgr").playerData.physicalPower = s.physicalPower);
...
this.setupData();
this.nameLabelNode.getComponent(cc.Label).string = e("textConfig").getTextByIdAndLanguageType(this.config.sectionDescripTextId);
...
for (var h in a) {
var s = a[h].conditions;
for (var o in s) {
var l = s[o], g = l.conditionType, r = l.conditionPara;
...
var n = this.contentNode.getChildByName("tapMonitoredNode");
n.width = i.width;
n.height = i.height;
n.on("touchstart", function() {
if (2 == t.status) {
...
var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null, i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 1, n = this.getSysBySysName(e);
if (null == n.opendNode) {
var a = cc.instantiate(n.uiPrefab), h = this.systems[n.name].mgrName, s = a.getComponent(h);
null != s && "function" == typeof s.onWillOpend && s.onWillOpend(t);
if (2 != i) {
var o = a.getChildByName("others"), l = a.getChildByName("bg");
if (null != l) {
...
var s = e("resMgr").reses.coverNodePrefab;
(s = cc.instantiate(s)).width = a.width;
s.height = a.height;
s.opacity = 0;
s.on("touchstart", function() {});
a.addChild(s);
...
var s = h.mail;
e("dataMgr").playerData.mails[i] = s;
var o = e("notificationMgr"), l = n.getTextByIdAndLanguageType(148);
o.pushNoti(l);
}
};
a.sendMessageByMsgObj(h);
}, h = e("mailSysConfig"), s = Object.keys(h);
for (var o in s) {
var l = s[o], g = e("dataMgr").playerData.mailConditionIndex[l];
if (-1 != g) {
...
var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : function() {}, a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, h = e("networkMgr"), s = h.makeMessageObj("mailModule", "sendMailMessageType");
