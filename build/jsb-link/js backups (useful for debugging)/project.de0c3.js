...
} else cc.sys.os != cc.sys.OS_ANDROID && cc.sys.os != cc.sys.OS_IOS || sdkbox.PluginAdMob.show("rewarded");
}
}))();
n.initAds();
t.exports = n;
...
var C = v.children[c], b = {};
b.name = C.name;
b.children = [];
for (var S in C.children) {
var M = g(C.children[S]);
b.children.push(M);
}
N.push(b);
}
l.pathWaysNode = N;
var T = s.getChildByName("bullets"), P = [];
...
if (null == n.opendNode) {
var a = cc.instantiate(n.uiPrefab), h = this.systems[n.name].mgrName, o = a.getComponent(h);
